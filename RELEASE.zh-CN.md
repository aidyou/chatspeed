...
- **全自动敏感信息过滤**: 在消息发送给 AI 之前，自动识别并掩盖姓名、身份证号、手机号、邮箱、IP 地址、信用卡等隐私信息。
- **深度适配合同场景**:
  - 新增 **机构名称识别**: 自动提取“甲方/乙方/承揽方”等合同角色及以“有限公司/集团”结尾的机构名。
  - 新增 **项目名称脱敏**: 识别并保护合同中的具体项目或课题名称。
  - 新增 **财务信息保护**: 自动掩盖合同金额（支持大写数字）及银行账号、开户行信息。
  - 新增 **座机与社交账号**: 支持中国及国际固定电话、微信 ID、QQ 号等。
- **灵活的名单管理**:
...
- **全语种 I18N 支持**: 为脱敏系统提供了 10 种语言（中、英、日、韩、德、法、西、葡、俄）的 UI 和占位符本地化显示。
