...
test('workflow uses a persistent navigation rail beside the collapsible task list', async () => {
  ...
  assert.doesNotMatch(sidebar, /open-terminal|workflow-terminal-entry|compact-terminal-entry/)
  assert.match(workflowView, /class="workflow-side-rail__item workflow-side-rail__terminal"[\s\S]*@click="terminal\.open"/)
