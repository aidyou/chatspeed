<template>
  <section class="workflow-session-message-pane" :data-agent-role="agentRole">
    ...
    <WorkflowMessageList
      ...
      :messages="messageProjection.enhancedMessages"
      :is-loading="isLoadingMessages"
      :hidden-earlier-message-count="messageProjection.hiddenEarlierMessageCount"
      ...
      :last-assistant-message="messageProjection.lastAssistantMessage"
      :approval-loading="approval.approvalLoading"
      :active-approval-id="approval.activeApprovalId"
      ...
      :is-approval-submitting="approval.isApprovalSubmitting"
