...
description: Install Chatspeed skills into ~/.chatspeed/skills from a curated list or a GitHub repo path. Use when a user asks to list installable skills, install a curated skill, or install a skill from another repo (including private repos).
---
...
- Installs into `~/.chatspeed/skills/<skill-name>`.
...
- Installed annotations come from `~/.chatspeed/skills`.
